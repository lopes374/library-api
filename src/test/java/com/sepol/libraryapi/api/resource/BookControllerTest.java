...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception {
        ...
        Book savedBook = Book.builder().id((long) 101).author("Alex").title("As aventuras").isbn("001").build();
    ...
    private BookDTO createNewBook() {
        return BookDTO.builder().author("Alex").title("As aventuras").isbn("001").build();
    }
